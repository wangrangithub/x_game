...
<form id="formupdate" >
	<div class="easyui-tabs" style="width: 100%;">
        <div title="活动基本信息">
            ...
            <input type="hidden" name="actId" value="${typeid}"/>
                <table width="100%" border="0" cellspacing="0" id="da" cellpadding="0" class="tk_table">
					<tr>
						...
						<td class="white-tr"><select name="actId"
							disabled="disabled">
								<option <c:if test="${typeid==1}">selected="selected"</c:if>
									value="1">财神投注活动</option>
						</select></td>
					</tr>
                    ...
                    <tr>
                    	 ...
                    	 <td class="white-tr">
                    	 	<input class="startDate Wdate" id="startDate" name="beginTime" value="${startTime }" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endDate\')}'})" value=""/>
                    	 </td>
                   	...
                   	<tr>
                    	 ...
                    	 <td class="white-tr">
                    	 	<input class="endDate Wdate" name="endTime" id="endDate"   value="${endTime }" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'startDate\')}',maxDate:'2120-10-01'})" value=""/>
                    	 </td>
                   	</tr>
                    <tr>
                        <td width="100px"><span class="font01 pr5">*</span>活动描述：</td>
                        <td class="white-tr">
                        	<textarea rows="10" cols="80" name="description">${description }</textarea>
                        </td>
                    </tr>
                </table><br/>
       ...
       <script type="text/javascript">
			...
			function edit(){
	    		...
	    		$("#formupdate").ajaxSubmit({
	    			...
	    			url:"<%= request.getContextPath()%>/activity/updateGodInfo",
	    			type:"post",
    ...
    <input type="button" onclick="edit();" class="search_bt commbtn" value="修改" >
