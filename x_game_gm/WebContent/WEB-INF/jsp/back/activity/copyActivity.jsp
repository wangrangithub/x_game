...
<form id="formupdate" >
                ...
                <table width="100%" border="0" cellspacing="0" id="da" cellpadding="0" class="tk_table">
                	<input id="actNam" type="hidden" class=""  name="" value="${activityInfo.actInfoName}"/>
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                        	 <input type="text" id="orginAct" class=""  name="actInfoName" value="${activityInfo.actInfoName}"/>
                        </td>
                    </tr>
                     <tr>
    ...
    <br/><br/><input type="button" onclick="push();" class="search_bt commbtn" value="复制" >
