...
<script type="text/javascript">
			...
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">充值数</span>：'
                    	+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="disabled"   type="text" class="rechargeDiamCount"  name="rechargeList['+j+'].rechargeDiamCount" value=""/>'
                    +'</td>'
					 +'</tr>'					
					  +'<tr>'
					 ...
					 +'<tr>'
                  		...
                  		+'<table border="0" id="attachTable">'
							+'<tr id="tr-attachments">' 
								+'<td align="center"  stuts="'+j+'"><input disabled="disabled"   type="button" value="添加奖励" onclick="addAttachLine(this);" class="add"></td>'
							...
							+'<td align="center"><a onclick="re(this);" href="javascript:void(0);" class="pn-opt">删除</a></td>'
								...
								+'<input disabled="disabled"   id=""  name="" type="hidden" style="width: 120px;" value="" class="count"  />'               	

								+'<td align="center"><input disabled="disabled"   class="rewardGoodsId" type="text" id="rewardGoodsId" name="rechargeList[0].rewardList[0].rewardGoodsId"/></td>'
								+'<td align="center"><input disabled="disabled"   class="rewardGoodsCount" type="text" id="rewardGoodsCount" name="rechargeList[0].rewardList[0].rewardGoodsCount"/></td>'
	...
	function attachindex(i,stus){
		...
		+'<td align="center"><a onclick="re(this);" href="javascript:void(0);" class="pn-opt">删除</a></td>'
		+'<input disabled="disabled"   id=""  name="" type="hidden" style="width: 120px;" value="" class="count"  />'  
		+'<td align="center"><input disabled="disabled"   type="text" class="rewardGoodsId" id="items[{0}].itemId" name="rechargeList['+stus+'].rewardList['+(i-1)+'].itemId"/></td>'
		+'<td align="center"><input disabled="disabled"   type="text" class="rewardGoodsCount" id="items[{0}].itemId" name="rechargeList['+stus+'].rewardList['+(i-1)+'].num"/></td>'
		+'<td align="center">'
...
<form id="formupdate" >
	<div class="easyui-tabs" style="width: 100%;">
        <div title="活动基本信息">
            ...
            <input disabled="disabled"   type="hidden"  class=""  name="actInfoId" value="${activityInfo.actInfoId}"/>
            <input disabled="disabled"   type="hidden"  class=""  name="actId" value="${activityInfo.actId}"/>
                <table width="100%" border="0" cellspacing="0" id="da" cellpadding="0" class="tk_table">
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                        	 <input disabled="disabled"   type="text" class=""  name="actInfoName" value="${activityInfo.actInfoName}"/>
                        </td>
                    </tr>
                     <tr>
                        <td width="100px"><span class="font01 pr5">*</span>活动图片：</td>
                        <td class="white-tr">
                        	 <input disabled="disabled"   type="text" class=""   name="actInfoPicture" value="${activityInfo.actInfoPicture}"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100px"><span class="font01 pr5">*</span>语言模板ID：</td>
                        <td class="white-tr">
                        	 <input disabled="disabled"   type="text" class=""   name="actLangTmpId" value="${activityInfo.actLangTmpId}"/>
                        </td>
                    </tr>
                     <tr>
                   		 <td width="100px"><span class="font01 pr5">*</span>开始时间：</td>
                    	 <td class="white-tr"><%-- <input disabled="disabled"    name="beginTimes" style="width: 120px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${param.beginTime }" class="search_txt"  />-
                    	  --%>
                    	 <input disabled="disabled"   class="startDate Wdate" id="startDate" name="actInfoStartTimes" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endDate\')}'})" value="${activityInfo.actInfoStartTime}"/>
                   	 ...
                   	 <tr>
                    	 ...
                    	 <td class="white-tr"><%-- <input disabled="disabled"   name="endTimes" style="width: 120px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${param.endTime}" class="search_txt"  />
                    	  --%>
                    	 <input disabled="disabled"   class="endDate Wdate" name="actInfoEndTimes" id="endDate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'startDate\')}',maxDate:'2120-10-01'})" value="${activityInfo.actInfoEndTime}"/>
                        ...
                        <td class="white-tr">
							...
							<c:forEach items="${activityInfo.rechargeList }" var="reC" varStatus="status">
								...
								<td align="left">
									<table >
											 <tr>
						                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">${typeid}数量条件</span>：
						                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="disabled"   type="text"    class="rechargeDiamCount"  name="rechargeList[${(status.count-1) }].rechargeDiamCount" value="${reC.rechargeDiamCount }"/>
						                        	<%-- <c:if test=""></c:if> --%>
						                        </td>
	                  						 </tr>
	                  						  <tr>
							                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片装备强化等级达标条件</span>：
							                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="disabled"   type="text" class="areanBegin"  name="rechargeList[${(status.count-1) }].rechargeCount" value="${reC.rechargeCount }"/>
							                        </td>
		                  						 </tr>
		                  						 <tr>
							                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片装备星级达标条件</span>：
							                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="disabled"   type="text" class="areanEnd"  name="rechargeList[${(status.count-1) }].cumulativePay" value="${reC.cumulativePay }"/><!-- （填写如：1_20，级别竞技场多少，1代表低级2中级3高级  20代表竞技场排名） -->
							                        </td>
		                  						 </tr>
	                  						  <tr>
						                        <td width=""><span class="font01 pr5">*</span>广播是否：
                	...
                	<br/><br/><input disabled="disabled"   type="button" onclick="push();" class="search_bt commbtn" value="保存" >
					<input disabled="disabled"   type="reset" class="search_bt commbtn" value="重置" >
					<input disabled="disabled"   type="button" onclick="goBack();" class="search_bt commbtn" value="返回" >
