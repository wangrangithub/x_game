                    ...
                    <tr>
                        ...
                        <td class="white-tr">
							...
							<td>
								<table>
										 <tr>
					                        <td width=""><span class="">*</span><span class="chongzhi">第一天充值</span>：
                  						 ...
                  						 <tr>
						                  		...
						                  		<table border="0" id="attachTable">
													...
													<tr id="attachTr{0}">
														...
														<td align="center"><input type="text" class="rewardGoodsId" id="items[{0}].itemId" name="rechargeList[0].rewardList[0].rewardGoodsId"/></td>
														<td align="center"><input type="text" class="rewardGoodsCount" id="items[{0}].itemId" name="rechargeList[0].rewardList[0].rewardGoodsCount"/></td>
														
														<td align="center">
															<select name="rechargeList[0].rewardList[0].rewardIsRadio" class="rewardIsR" id="type" onChange="Change_Select()">
																<option value="0">无</option>
																<option value="1">本服</option>
																<option value="2">全服</option>
															</select>
                  						 ...
                  						 <tr>
												...
												<textarea style="display:none" id="emailT">
													<tr id="attachTr{0}">
														...
														<input id=""  name="" type="hidden" style="width: 120px;" value="" class="count"  />  
														<td align="center"><input type="text" class="rewardGoodsId" id="items[{0}].itemId" name="rechargeList[0].rewardList[0]."/></td>
														<td align="center"><input type="text" class="rewardGoodsCount" id="items[{0}].itemId" name="rechargeList[0].rewardList[0]."/></td>
