...
<script type="text/javascript">
	function emailindex(i){
		...
		+'<td align="left">'
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">充值条件</span>：'
...
<script type="text/javascript">
	function emailindexs(i){
		...
		+'<td align="left">'
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="font01 pr5">*</span><span class="">累计天数</span>：'
                    	+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="rechargeDiamCount" sta="1" name="rechargeList['+j+'].cumulativePay" value=""/>'
                    +'</td>'
					 +'</tr>'					
					  +'<tr>'
                    +'<td width=""><span class="font01 pr5">*</span>广播是否：'
                    ...
                    +'</td>'                    
					 ...
					 +'<tr>'
                  		...
                  		+'<table border="0" id="attachTable">'
							+'<tr id="tr-attachments">' 
								+'<td align="center"  stut="'+j+'"><input type="button" value="添加奖励" onclick="addAttachLines(this);" class="add"></td>'
								+'<td align="center">物品ID</td>'
								+'<td align="center">物品数量</td>'
								+'<td align="center">是否广播</td>'
							+'</tr>'
	...
	function attachindexs(i,stus){
		...
		+'<td align="center"><a onclick="re(this);" href="javascript:void(0);" class="pn-opt">删除</a></td>'
		+'<input id=""  name="" type="hidden" style="width: 120px;" value="" class="count"  />'  
		+'<td align="center"><input type="text" class="rewardGoodsId" id="items[{0}].itemId" name="rechargeList['+stus+'].cumulativeRewardList['+(i-1)+'].itemId"/></td>'
		+'<td align="center"><input type="text" class="rewardGoodsCount" id="items[{0}].itemId" name="rechargeList['+stus+'].cumulativeRewardList['+(i-1)+'].num"/></td>'
		+'<td align="center">'
			+'<select name="rechargeList['+stus+'].cumulativeRewardList['+(i-1)+'].notice" class="rewardIsR" id="type" onChange="Change_Select()">'
				+'<option value="0">无</option>'
				+'<option value="1">本服</option>'
				+'<option value="2">全服</option>'
			+'</select>'
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                        	<select name="actId" disabled="disabled">
		                        		...
		                        		<option <c:if test="${typeid==1007}">selected="selected"</c:if> value="1007">充值循环达标</option>
		                        		<option <c:if test="${typeid==1008}">selected="selected"</c:if> value="1008">钻石消费循环达标</option>
		                        		<option <c:if test="${typeid==1009}">selected="selected"</c:if> value="1009">累计消费钻石达标</option>
		                        		<option <c:if test="${typeid==1010}">selected="selected"</c:if> value="1010">登陆达标</option>
		                        		<option <c:if test="${typeid==1011}">selected="selected"</c:if> value="1011">芯片装备达标</option>
		                        		<option <c:if test="${typeid==1012}">selected="selected"</c:if> value="1012">幸存者星级达标</option>
		                        		<option <c:if test="${typeid==1013}">selected="selected"</c:if> value="1013">活动获得指定幸存者</option>
		                        		<option <c:if test="${typeid==1014}">selected="selected"</c:if> value="1014">关卡进度达标(普通关卡)</option>
		                        		<option <c:if test="${typeid==1015}">selected="selected"</c:if> value="1015">关卡进度达标(工业区)</option>
		                      </select>
                        </td>
                    </tr> 
                        ...
                        <td class="white-tr">
							...
							<td>
								<table >
										 <tr>
					                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">充值条件</span>：
					                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="rechargeDiamCount"  name="rechargeList[1].rechargeDiamCount" value=""/><!-- （填写如：1_20，第几天充值多少，1代表天数 20代表充值钱数。累计则直接填天数即可例 1） -->
					                        </td>
                  						 </tr>
                  						  <tr>
					                        <td width=""><span class="font01 pr5">*</span>广播是否：
					                         	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					                         	<select class="rechargeIsRadio" name="rechargeList[1].rechargeIsRadio" id="type" onChange="Change_Select()">
																<option value="0">无</option>
																<option value="1">本服</option>
																<option value="2">全服</option>
															</select>
                  						 ...
                  						 <tr>
						                  		...
						                  		<table border="0" id="attachTable">
													<tr id="tr-attachments"> 
														<td align="center" stuts="1"><input type="button" value="添加奖励" onclick="addAttachLine(this);" class="add"></td>
													...
													<tr id="attachTr{0}">
														...
														<td align="center"><input type="text" class="rewardGoodsId" id="items[{0}].itemId" name="rechargeList[1].rewardList[0].itemId"/></td>
														<td align="center"><input type="text" class="rewardGoodsCount" id="items[{0}].itemId" name="rechargeList[1].rewardList[0].num"/></td>
														
														<td align="center">
															<select name="rechargeList[1].rewardList[0].notice" class="rewardIsR" id="type" onChange="Change_Select()">
																<option value="0">无</option>
																<option value="1">本服</option>
																<option value="2">全服</option>
															</select>
                    ...
                    <script type="text/javascript">
						...
						//	var et="].language";
				               // alert($.format($("#emailTr").val()));
								...
								//$(".rechargeDiamCount:last").attr("name","rechargeList["+1+"].cumulativePay");
								/* var ind=0;
                        ...
                        <td class="white-tr">
							...
							<td>
								<table >
										 <tr>
					                        <td width=""><span class="font01 pr5">*</span><span class="">累计天数</span>：
					                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" sta="1" class="rechargeDiamCount"  name="rechargeList[0].cumulativePay" value=""/>
					                        </td>
                  						  <tr>
					                        <td width=""><span class="font01 pr5">*</span>广播是否：
					                         	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					                         	<select class="rechargeIsRadio" name="rechargeList[0].rechargeIsRadio" id="type" onChange="Change_Select()">
																<option value="0">无</option>
																<option value="1">本服</option>
																<option value="2">全服</option>
															</select>
                  						 ...
                  						 <tr>
						                  		...
						                  		<table border="0" id="attachTable">
													...
													<tr id="attachTr{0}">
														<td align="center"><a onclick="re(this);" href="javascript:void(0);" class="pn-opt">删除</a></td>
														<td align="center"><input type="text" class="itemId" id="items[{0}].itemId" name="rechargeList[0].rewardList[0].itemId"/></td>
														<td align="center"><input type="text" class="num" id="items[{0}].itemId" name="rechargeList[0].rewardList[0].num"/></td>
														
														<td align="center">
															<select name="rechargeList[0].rewardList[0].notice" class="notice" id="type" onChange="Change_Select()">
																<option value="0">无</option>
																<option value="1">本服</option>
																<option value="2">全服</option>
															</select>
