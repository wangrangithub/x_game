...
<script type="text/javascript">
	function emailindex(i){
		...
		+'<td align="left">'
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">每日充值</span>：'
									...
									<table >
											 <tr>
						                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">${typeid}条件</span>：
						                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"    class="rechargeDiamCount"  name="rechargeList[${(status.count-1) }].rechargeDiamCount" value="${reC.rechargeDiamCount }"/>
						                        	<%--  <c:if test="${reC. }"></c:if> --%>
						                        </td>
	                  						 </tr>
	                  						  <tr>
										...
										<c:if test="${reCH.cumulativePay != null}">
										 <tr>
					                        <td width=""><span class="font01 pr5">*</span><span class="">累计天数</span>：
					                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" sta="1" class="rechargeDiamCount"  name="rechargeList[0].cumulativePay" value="${reCH.cumulativePay}"/>
					                        </td>
                  						  <tr>
					                        <td width=""><span class="font01 pr5">*</span>广播是否：
					                         	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  						 ...
                  						 <tr>
						                  		...
						                  		<table border="0" id="attachTable">
													...
													<c:forEach items="${reCH.rewardList }" var="reWA" varStatus="stat">
														<tr id="attachTr{0}">
															<td align="center"><a onclick="re(this);" href="javascript:void(0);" class="pn-opt">删除</a></td>
															<td align="center"><input type="text" value="${reWA.itemId}" class="itemId" id="items[{0}].itemId" name="rechargeList[0].rewardList[0].itemId"/></td>
															<td align="center"><input type="text" value="${reWA.num}" class="num" id="items[{0}].itemId" name="rechargeList[0].rewardList[0].num"/></td>
