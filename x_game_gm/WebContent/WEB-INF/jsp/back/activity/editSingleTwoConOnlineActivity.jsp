                ...
                <table width="100%" border="0" cellspacing="0" id="da" cellpadding="0" class="tk_table">
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                            ...
                            <input type="radio"  disabled="disabled" <c:if test="${activityInfo.isOpenTmpl==0}">checked="checked"</c:if> class=""  name="isOpenTmpl" value="0"/>否
                            <input type="radio"  disabled="disabled" <c:if test="${activityInfo.isOpenTmpl==1}">checked="checked"</c:if>  class=""  name="isOpenTmpl" value="1"/>开服模板
                            <br />
									...
									<table >
											 <tr>
						                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">${typeid}条件</span>：
						                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="disabled"  type="text"  disabled="disabled" class="rechargeDiamCount"  name="rechargeList[${(status.count-1) }].rechargeDiamCount" value="${reC.rechargeDiamCount }"/>
						                        	<%-- <c:if test=""></c:if> --%>
						                        </td>
	                  						 </tr>
	                  						  <tr>
							                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">可重复领取上限</span>：
							                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="disabled"  type="text" disabled="disabled" class="areanBegin"  name="rechargeList[${(status.count-1) }].rechargeCount" value="${reC.rechargeCount }"/>
							                        </td>
		                  						 </tr>
	                  						  <tr>
						                        <td width=""><span class="font01 pr5">*</span>广播是否：
						                         	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						                         	<select class="rechargeIsRadio" name="rechargeList[${(status.count-1) }].rechargeIsRadio" id="type" disabled="disabled"   onChange="Change_Select()">
