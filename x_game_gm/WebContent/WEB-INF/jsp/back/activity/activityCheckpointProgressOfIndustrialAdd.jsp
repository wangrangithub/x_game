...
<script type="text/javascript">
	function emailindex(i){
		...
		+'<td align="left">'
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">指定关卡(工业区)ID</span>：'
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                        	<select name="actId" disabled="disabled">
		                        		<option <c:if test="${typeid==1015}">selected="selected"</c:if> value="1015">通关指定关卡(工业区)</option>
		                      </select>
                        </td>
                    </tr> 
