...
<script type="text/javascript">
	function emailindex(i){
		...
		+'<td align="left">'
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">钻石消费循环达标条件</span>：'
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                        	<select name="actId" disabled="disabled">
		                        		<option <c:if test="${typeid==1008}">selected="selected"</c:if> value="1008">钻石消费循环循环达标</option>
		                      </select>
                        </td>
                    </tr> 
