											 ...
											 <tr>
	                  						  ...
	                  						  <tr>
							                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片装备强化等级达标条件</span>：
							                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="rechargeCount"  name="rechargeList[${(status.count-1) }].rechargeCount" value="${reC.rechargeCount }"/>
							                        </td>
		                  						 </tr>
		                  						 <tr>
							                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片装备星级达标条件</span>：
							                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="cumulativePay"  name="rechargeList[${(status.count-1) }].cumulativePay" value="${reC.cumulativePay }"/><!-- （填写如：1_20，级别竞技场多少，1代表低级2中级3高级  20代表竞技场排名） -->
							                        </td>
		                  						 </tr>
	                  						  <tr>
						                        <td width=""><span class="font01 pr5">*</span>广播是否：
