...
<script type="text/javascript">
	function emailindex(i){
		...
		+'<td align="left">'
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="">*</span><span class="chongzhi">充值数</span>：'
            ...
            <input type="hidden"  class=""  name="actInfoId" value="${activityInfo.actInfoId}"/>
                <table width="100%" border="0" cellspacing="0" id="da" cellpadding="0" class="tk_table">
                	<input id="actNam" type="hidden" class=""  name="" value="${activityInfo.actInfoName}"/>
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                            ...
                            <br />
                            	开始第 <input type="text" disabled="disabled" value="${activityInfo.actInfoStartDay}" name="actInfoStartDay"/>天 结束第<input type="text" disabled="disabled" value="${activityInfo.actInfoEndDay}" name="actInfoEndDay"/>天
                        </td>
                    </tr>
                     <tr>
                        <td width="100px"><span class="font01 pr5">*</span>精彩活动名称：</td>
                        <td class="white-tr">
                        	 <input type="text" id="orginAct" disabled="disabled" class=""  name="actInfoName" value="${activityInfo.actInfoName}"/>
                        </td>
                    </tr>
                     <tr>
                        <td width="100px"><span class="font01 pr5">*</span>活动图片：</td>
                        <td class="white-tr">
                        	 <input type="text" class="" disabled="disabled"  name="actInfoPicture" value="${activityInfo.actInfoPicture}"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100px"><span class="font01 pr5">*</span>语言模板ID：</td>
                        <td class="white-tr">
                        	 <input type="text" class="" disabled="disabled"  name="actLangTmpId" value="${activityInfo.actLangTmpId}"/>
                        </td>
                    </tr>
                     <tr>
                    	 ...
                    	 <td class="white-tr"><%-- <input  name="beginTimes" style="width: 120px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${param.beginTime }" class="search_txt"  />-
                    	  --%>
                    	 <input class="startDate Wdate"  disabled="disabled" id="startDate" name="actInfoStartTimes" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endDate\')}'})" value="${activityInfo.actInfoStartTime}"/>
                   	 ...
                   	 <tr>
                    	 ...
                    	 <td class="white-tr"><%-- <input name="endTimes" style="width: 120px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${param.endTime}" class="search_txt"  />
                    	  --%>
                    	 <input class="endDate Wdate" disabled="disabled"  name="actInfoEndTimes" id="endDate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'startDate\')}',maxDate:'2120-10-01'})" value="${activityInfo.actInfoEndTime}"/>
                    ...
                    <tr>
                        ...
                        <td class="white-tr">
                        	<textarea rows="10" cols="10" disabled="disabled" name="actInfoDes" value="">${activityInfo.actInfoDes}</textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="white-tr">
							...
							<tr>
								<td align="center"><input type="button" value="添加活动项" disabled="disabled" onclick="addEamilLine();"></td>
							</tr>
									...
									<table >
											 <tr>
						                        <td width=""><span class="">*</span><span class="chongzhi">${typeid}条件</span>：
						                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" disabled="disabled" class="rechargeDiamCount"  name="rechargeList[${(status.count-1) }].rechargeDiamCount" value="${reC.rechargeDiamCount }"/>
						                        </td>
	                  						 </tr>
	                  						  <tr>
						                        <td width=""><span class="">*</span>广播是否：
	                  						 ...
	                  						 <tr>
							                  		...
							                  		<table border="0" id="attachTable">
														<tr id="tr-attachments"> 
															<td align="center" stuts="0"><input type="button" disabled="disabled" value="添加奖励" onclick="addAttachLine(this);" class="add"></td>
