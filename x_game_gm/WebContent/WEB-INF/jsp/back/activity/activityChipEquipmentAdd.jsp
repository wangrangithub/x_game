...
<script type="text/javascript">
	function emailindex(i){
		...
		+'<td align="left">'
			+'<table class="email">'
				+'<tr>'
                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片装备数量达标条件</span>：'
                    	+'<input type="text" class="rechargeDiamCount"  name="rechargeList['+j+'].rechargeDiamCount" value=""/>'
                    +'</td>'
					 +'</tr>'
					 +'<tr>'
	                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片强化等级达标条件</span>：'
	                    	+'<input type="text" class="rechargeCount"  name="rechargeList['+j+'].rechargeCount" value=""/>'
	                    +'</td>'
						 +'</tr>'
					 +'<tr>'
	                   +'<td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片装备星级达标条件</span>：'
	                    	+'<input type="text" class="cumulativePay"  name="rechargeList['+j+'].cumulativePay" value=""/>'
	                    +'</td>'
						 +'</tr>'
					  +'<tr>'
                ...
                <table width="100%" border="0" cellspacing="0" id="da" cellpadding="0" class="tk_table">
                     ...
                     <tr>
                        ...
                        <td class="white-tr">
                        	<select name="actId" disabled="disabled">
		                        		<option <c:if test="${typeid==1011}">selected="selected"</c:if> value="1011">芯片装备循环达标</option>
		                      </select>
                        </td>
                    </tr> 
							...
							<td>
								<table >
										 <tr>
                  						 ...
                  						 <tr>
					                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">芯片装备星级达标条件</span>：
					                        	<input type="text" class="cumulativePay"  name="rechargeList[0].cumulativePay" value=""/>
					                        </td>
                  						 </tr>
                  						  <tr>
					                        <td width=""><span class="font01 pr5">*</span>广播是否：
                    ...
                    <script type="text/javascript">
							...
							function addEamilLine() 
							{
								...
								$(".cumulativePay").each(function(index){
