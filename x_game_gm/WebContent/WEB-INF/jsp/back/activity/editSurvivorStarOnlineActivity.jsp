                        ...
                        <td class="white-tr">
							...
							<c:forEach items="${activityInfo.rechargeList }" var="reC" varStatus="status">
								...
								<td align="left">
									<table >
											 <tr>
						                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">幸存者ID</span>：
	                  						  ...
	                  						  <tr>
							                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">幸存者数量达标条件</span>：
		                  						 ...
		                  						 <tr>
							                        <td width=""><span class="font01 pr5">*</span><span class="chongzhi">幸存者星级达标条件</span>：
