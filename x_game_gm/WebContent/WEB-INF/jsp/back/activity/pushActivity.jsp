	...
	function addConfine() {
	 ...
	 function push(){
	 	  ...
	 	  var state = $("#state").val();
    		...
    		$("#formadd").ajaxSubmit({
    			url:"<%= request.getContextPath()%>/activity/pushActivity?serverIds="+array+"&actInfoId="+id,
    			type:"post",
    			data:  $('#formadd').serialize(),
 				dataType: "json",
    			resetForm:false,
...
<form id="formadd" method="post" action="<%=request.getContextPath()%>/shop/offList">
	<div class="easyui-tabs" style="width: 100%;">
        <div title="推送基本信息">
       <input type="hidden" class="" id="id" value="${activityInfo.actInfoId }"  name="id" />
            ...
            <div class="dialog-table">
                <table id="ta" width="100%" border="0" cellspacing="0" cellpadding="0" class="tk_table">
                    ...
                    <tr>
                        ...
                        <td class="white-tr">
                        <input type="text" class="" disabled="disabled" id="txtdeptname" value="${activityInfo.actInfoName }" onclick="" name="act_name" />
                  		</td>
                    </tr>
                    
                    <tr>
                   		 <td width="100px">活动开始时间：</td>
                    	 <td class="white-tr"><input  name="beginTimes" disabled="disabled" style="width: 120px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${activityInfo.actInfoStartTime }" class="search_txt"  />-</td>
                    	
                   	</tr>
                   	 <tr>
                   		<td width="100px">活动结束时间：</td>	
                    	 <td class="white-tr"><input name="endTimes" style="width: 120px;" disabled="disabled" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${activityInfo.actInfoEndTime}" class="search_txt"  /></td>
