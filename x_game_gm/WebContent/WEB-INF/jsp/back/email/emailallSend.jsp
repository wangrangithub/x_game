...
<title>Insert title here</title>
	...
	function addConfine() {
	 ...
	 function redirectUrl(){
		    window.location.href = "${base}/admin/app/emailgm/emailAllsend";
		}
    	...
    	function addAllEmail(){
    	  ...
    	  //  alert(array);
    		$("#formadd").ajaxSubmit({
    			url:"<%= request.getContextPath()%>/email/emailallSend?serverIds="+array,
    			type:"post",
                ...
                <table id="ta" width="100%" border="0" cellspacing="0" cellpadding="0" class="tk_table">
                 ...
                 <!--    <script type="text/javascript">
                    ...
                    <tr>
                        ...
                        <input type="radio" class="" id="txtdeptname" value="2" onclick="selectFangShi()" name="receivetype" checked="checked"/>用户级别
                  		<input type="radio" class="" id="txtdeptname" value="3" onclick="selectFangShi()" name="receivetype" />等级级别
                   ...
                   <tr>
                        ...
                        <td class="white-tr">
                          <textarea id="letter.uids" name="uids" rows="5" cols="80"></textarea>
						 	<span class="">多个uid用英文标点','隔开</span>
                        </td>
                    </tr>	
                    <tr id="fstimelevel">
                        <td width="100px"><span class="font01 pr5">*</span>等级:</td>
                        <td class="white-tr">
                         <textarea maxlength="10" id="letter.level" name="level" rows="1" cols="5"></textarea>至
                         <textarea maxlength="10" id="letter.levelmax" name="levelmax" rows="1" cols="5"></textarea>
                        </td>
                    </tr>	
                    <tr>
                    ...
                    <tr>
                        <td width="100px"><span class="font01 pr5">*</span>默认邮件内容：</td>
                        <td class="white-tr">
                           <textarea rows="15" cols="10" name="language[0].content"> 
					 ...
					 <tr>
						...
						<textarea style="display:none" id="emailTr">
							<tr id="emaiTr{0}">
								...
								<td align="left">
									邮件类型:
									<select class="select" id="letter.language[{0}].language" name="">
									...
									<br/><br/>
									邮件标题:
									<input type="text" class="inputtitle" id="letter.language[{0}].title" maxlength="40" name="" class="required">
									<br/><br/>
									邮件内容:
                     ...
                     <tr>
						...
						<textarea style="display:none" id="attachTr">
							<tr id="attachTr{0}">
								...
								<td align="center"><input type="text" class="inputid" id="letter.items[{0}].itemId" name=""/></td>
								<td align="center">
									<span id="afc{0}" style="position:relative;display:block;">
										<input type='text' class="inputnum" name="" id='letter.items[{0}].num'/>
									</span>
								</td>
							</tr>
						</textarea>
					...
					<br/><br/><br/><input type="submit" class="search_bt commbtn" value="提交" onclick="addAllEmail();return false;" >
