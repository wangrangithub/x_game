...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/rolesearch/runesearch">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">角色管理</span><span class="pl5">></span><span class="pl5">符文查询</span></p>
                </div>
                <!--功能按钮区域-->
                <div class="function">
                ...
                <div class="funsearch">
                    ...
                    <input type="button" onclick="pageIndexChanging(1, 'form1');" class="search_bt commbtn" value="符文查询" />
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">当地</th>
							<th style="width:100px;">扩展属性</th>
							<th style="width:100px;">奴隶属性</th>
							<th style="width:100px;">主要的属性ID</th>
                   ...
                   <c:forEach items="${pageModel.dateList}" var="all" varStatus="status">
                        <tr>
                            ...
                            <td>${all.uid}</td>
                            <td>${all.location }</td>
                            <td>${all.extendAttr }</td>
                            <td>${all.slaveAttr }</td>
                            <td>${all.masterAttrId }</td>
                             <td>${all.type }</td>
                            <td>${all.level }</td>
