...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/rolesearch/openIDsearch">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">角色管理</span><span class="pl5">></span><span class="pl5">openID查询</span></p>
                </div>
                <!--功能按钮区域-->
                <div class="clear"></div>
                <!--查询条件区域-->
                <div class="funsearch">
                    <div class="search_list">
                         	请输入ID：
                    	<input  name="openId" style="width: 120px;" value="${param.openId }" class="search_txt"  />                  	
                    ...
                    <input type="button" onclick="pageIndexChanging(1, 'form1');" class="search_bt commbtn" value="openID查询" />
                	      	<!-- <div class="search_list">
                    	  	请输入id：
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">平台用户ID</th>
							<th style="width:100px;">平台名称</th>
							<th style="width:100px;">平台ID</th>
							<th style="width:100px;">用户名称</th>
							<th style="width:100px;">email</th>
							<th style="width:100px;">最后一次登录时间</th>
							
                        </tr>
                    </thead>
                    <!--数据部分-->
                    <tbody>
                   <c:forEach items="${pageModel.dateList}" var="open" varStatus="status">
                        <tr>
                            <td>
                                <input id="id0" type="checkbox" name="chkDeptIds" value="${open.uid }" /></td>
                            <td>${status.count}</td>
                            <td>${open.uid}</td>  
                            <td>${open.openId}</td>                           
                            <td>${open.platformId}</td>
                            <td>${open.platformName }</td>
                           <%--  <td>${open.nowExp }</td> --%>
                            <td>${open.userName }</td>
                             <td>${open.email }</td>
                            <td>
