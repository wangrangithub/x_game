...
<body class="easyui-layout">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/rolesearch/alliSearch">
        <div class="container">
            <div class="content">
                <div class="loaction">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	  	请输入联盟id：
                    	<input id="inp"  name="type" style="width: 120px;" value="${param.type }"  class="search_txt"  />                 	
                   			请输入联盟名称：
                    	<input  name="info" style="width: 120px;" value="${param.info}"  class="search_txt"  />                 	
                    ...
                    <input type="button" onclick="pageIndexChanging(1, 'form1');" class="search_bt commbtn" value="联盟查询" />
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">创建者uid</th>
							<th style="width:100px;">领导者uid</th>
							<th style="width:100px;">联盟ID</th>
							<th style="width:100px;">等级</th>
							<th style="width:100px;">成员</th>
							<th style="width:100px;">创建时间</th>
							<th style="width:100px;">成员列表</th>
                   ...
                   <c:forEach items="${pageModel.dateList}" var="all" varStatus="status">
                        <tr>
                            <td>
                                <input id="id0" type="checkbox" name="chkDeptIds" value="" /></td>
                            <td>${status.count}</td>
                            <td>${all.name}</td>                           
                            <td>${all.creatorUid}</td>
                            <td>${all.leaderUid }</td>
                            <td>${all.allianceId }</td>
  
                            <td>${all.level}</td>
                            <td>${all.member }</td>
                            <td>${all.createTime }</td>
                            <td>${all.memberList }</td>                          
                        </tr>                        
                    </c:forEach> 
