...
<body class="easyui-layout">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/rolesearch/uidManager">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">角色管理</span><span class="pl5">></span><span class="pl5">uid管理</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	         请输入本人uid：
                    	<input  name="selfUid" style="width: 120px;"  class="search_txt" value="${param.selfUid }" />                   	
                   		   请输入目标uid：
                    	<input  name="targetUid" style="width: 120px;"  class="search_txt" value="${param.targetUid }" />                   	
                   		选择服：
