...
<head>
	...
	<script type="text/javascript">
		...
		function pageIndexChanging(newPageIndex, formid){
			...
			var idpu=$("#inpu").val();
			//alert(idp);
			if(isNaN(Number(idp)) ||isNaN(Number(idpu))){
	            alert('请输入正确！');
	        }else{
				$("#"+formid).submit();
	        }
...
<body class="easyui-layout">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/rolesearch/userBlock">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">角色管理</span><span class="pl5">></span><span class="pl5">用户封禁</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	<div class="search_list">
                         	请输入uid：
                    	<input id="inp"  name="uid" style="width: 120px;"  class="search_txt"  />                 	
                
                         	请输入时长(最大43200分钟)：
                    	<input id="inpu" name="minute" style="width: 120px;"  class="search_txt"  />
