...
<body class="easyui-layout">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/rolesearch/userUnBlock">
        <div class="container">
            <div class="content">
                <div class="loaction">
                ...
                <div class="funsearch">
                    ...
                    <input type="button" onclick="pageIndexChanging(1, 'form1');" class="search_bt commbtn" value="解封用户" />
