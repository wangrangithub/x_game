...
<body class="easyui-layout">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/gameServer/ugc">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">服务器</span><span class="pl5">></span><span class="pl5">ugc全清档</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    ...
                    <input type="button" onclick="pageIndexChanging(1, 'form1');" class="search_bt commbtn" value="ugc全清" />
