...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/heroLevelUpJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">武将升级日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	...
                    	英雄ID：
                    	<input name="hid" id="inp" style="width: 120px;" value="${param.hid}" class="search_txt"  />
                    	   选择服：
                	...
                	<a href="<%= request.getContextPath()%>/journal/heroLevelUpExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&hid=${hid}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">升级前等级</th>
							<th style="width:100px;">升级后等级</th>
							<th style="width:100px;">经验变化理</th>
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="heroLU" varStatus="status">
                        <tr>
                            <td>${heroLU.id }</td>
                            <td>${heroLU.uid }</td>
                            <td>${heroLU.heroId }</td>
                            <td>${heroLU.origLevel }</td>
                            <td>${heroLU.curLevel }</td>
                            <td>${heroLU.costs }</td>
                            <td>${heroLU.logReason }</td>
                            <td>${heroLU.name }</td>
                            <td>${heroLU.level }</td>
                            <td>${heroLU.registTime }</td>
                            <td>${heroLU.logTime }</td>
