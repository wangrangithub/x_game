...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/mysteryShopInfoJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">神秘商城日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	...
                    	用户ID：
                    	<input name="id" id="inp" style="width: 120px;" value="${param.id}" class="search_txt"  />
                    	   选择服：
                	...
                	<a href="<%= request.getContextPath()%>/journal/shopInfoExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">是否花钱</th>
							<th style="width:100px;">商品1</th>
							<th style="width:100px;">商品2</th>
							<th style="width:100px;">商品3</th>
							<th style="width:100px;">商品4</th>
							<th style="width:100px;">商品5</th>
							<th style="width:100px;">商品6</th>
							<th style="width:100px;">商品7</th>
							<th style="width:100px;">商品8</th>
							<th style="width:100px;">商品9</th>
							<th style="width:100px;">商品10</th>
							<th style="width:100px;">商品11</th>
							<th style="width:100px;">商品12</th>
							<th style="width:100px;">注册时间</th>
                        </tr>
                    </thead>
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="shopInfo" varStatus="status">
                        <tr>
                            <td>${shopInfo.uid }</td>
                            <td>${shopInfo.name }</td>
                            <td>${shopInfo.level }</td>
                            <td>${shopInfo.iscost }</td>
                            <td>${shopInfo.shop1 }</td>
                            <td>${shopInfo.shop2 }</td>
                            <td>${shopInfo.shop3 }</td>
                            <td>${shopInfo.shop4 }</td>
                             <td>${shopInfo.shop5 }</td>
                              <td>${shopInfo.shop6 }</td>
                            <td>${shopInfo.shop7 }</td>
                             <td>${shopInfo.shop8 }</td>.
                             <td>${shopInfo.shop9 }</td>
                             <td>${shopInfo.shop10 }</td>
                             <td>${shopInfo.shop11 }</td>
                             <td>${shopInfo.shop12 }</td>
                            <td>${shopInfo.registTime }</td>
                        </tr>                        
                    </c:forEach>
