...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/emailReceiveJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">邮件收取日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                	...
                	<a href="<%= request.getContextPath()%>/journal/emailReceiveExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&gid=${gid}&res=${res}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">gm发的ID</th>
							<th style="width:100px;">多语言模板ID</th>
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="emailR" varStatus="status">
                        <tr>
                            <td>${emailR.uid }</td>
                            <td>${emailR.name }</td>
                            <td>${emailR.gmid }</td>
                            ...
                            <td>${emailR.grains }</td>
                             ...
                             <td>${emailR.logReason }</td>
                              
                            
                             <td>${emailR.logTime }</td>
                            <td>${emailR.registTime }</td>
                        </tr>                        
                    </c:forEach>
