...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/recruitItemJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">招募道具日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	...
                    	<input name="id" id="long" style="width: 120px;" value="${param.id}" class="search_txt"  />
                    	 道具ID：
                    	<input name="iid" id="inp" style="width: 120px;" value="${param.iid}" class="search_txt"  />
                    	  原因 ：
                	...
                	<a href="<%= request.getContextPath()%>/journal/recruitItemExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&iid=${iid}&res=${res}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">获得数量</th>
							<th style="width:100px;">总的数量</th>
                    ...
                    <c:forEach items="${pageModel.dateList}" var="resource" varStatus="status">
                        <tr>
                            <td>${resource.uid }</td>
                            <td>${resource.name }</td>
                            <td>${resource.heroId }</td>
                            <td>${resource.itemId }</td>
                            <td>${resource.num }</td>
                            <td>${resource.logReason }</td>
                            <td>${resource.registTime }</td>
