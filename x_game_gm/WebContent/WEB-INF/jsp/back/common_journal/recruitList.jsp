...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/recruitJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">招募日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	...
                    	招募ID：
                    	<input name="zid" id="inp" style="width: 120px;" value="${param.zid}" class="search_txt"  />
                    	  原因 ：
                	...
                	<a href="<%= request.getContextPath()%>/journal/recruitExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&zid=${zid}&res=${res}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">招募ID</th>
							<th style="width:100px;">招募类型</th>
							<th style="width:100px;">招募消耗</th>
							<th style="width:100px;">招募获得</th>
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="recruit" varStatus="status">
                        <tr>
                            <td>${recruit.id }</td>
                            <td>${recruit.recruitId }</td>
                            <td>${recruit.recruitType }</td>
                            <td>${recruit.costs }</td>
                            <td>${recruit.rewards }</td>

                            <td>${recruit.logReason }</td>
                             <td>${recruit.name }</td>
                            <td>${recruit.level }</td>
                             <td>${recruit.logTime }</td>
                            <td>${recruit.registTime }</td>
