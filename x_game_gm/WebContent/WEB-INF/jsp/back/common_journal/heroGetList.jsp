...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/heroGetJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">武将获得日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                	...
                	<a href="<%= request.getContextPath()%>/journal/heroGetExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&hid=${hid}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="heroG" varStatus="status">
                        <tr>
                            <td>${heroG.uid }</td>
                            <td>${heroG.name }</td>
                            <td>${heroG.heroUid }</td>
                            ...
                            <td>${heroG.quality }</td>
                            <td>${heroG.isWake }</td>
                            <td>${heroG.logReason }</td>
                            <td>${heroG.others }</td>
                            <td>${heroG.registTime }</td>
                            <td>${heroG.logTime }</td>
