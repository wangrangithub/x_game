...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/allianceFightLog">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">联盟战个人战斗日志</span></p>
                </div>
                <!--功能按钮区域-->
                <div class="clear"></div>
                <!--查询条件区域-->
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">获得贡献</th>
							<th style="width:100px;">联盟战标记</th>
							<th style="width:100px;">伤害</th>
							<th style="width:100px;">防御者UID</th>
							<th style="width:100px;">敌方联盟ID</th>
							<th style="width:100px;">战斗结果</th>
							<th style="width:100px;">攻击者UID</th>
							<th style="width:100px;">关卡</th>
                    ...
                    <c:forEach items="${pageModel.dateList}" var="devote" varStatus="status">
                        <tr>
                            ...
                            <td>${devote.symbol }</td>
                            <td>${devote.damage }</td>
                            <td>${devote.defenseUid }</td>
                            <td>${devote.defenseId }</td>
                            <td>${devote.result }</td>
                            <td>${devote.attackUid }</td>
                            <td>${devote.stageId }</td>
