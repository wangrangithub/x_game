...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/heroLevelJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">武将升阶日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                	...
                	<a href="<%= request.getContextPath()%>/journal/export.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&hid=${hid}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">升阶前等级</th>
							<th style="width:100px;">升阶后等级</th>
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="heroL" varStatus="status">
                        <tr>
                            <td>${heroL.id }</td>
                            <td>${heroL.uid }</td>
                            <td>${heroL.heroId }</td>
                            <td>${heroL.origLevel }</td>
                            <td>${heroL.curLevel }</td>
                            <td>${heroL.expChange }</td>
                            <td>${heroL.logReason }</td>
                            <td>${heroL.name }</td>
                            <td>${heroL.level }</td>
                            <td>${heroL.registTime }</td>
                            <td>${heroL.logTime }</td>
