...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/shopJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">商城日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                	...
                	<a href="<%= request.getContextPath()%>/journal/shopExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&gid=${gid}&res=${res}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">货架编号</th>
							<th style="width:100px;">获得物品</th>
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="shop" varStatus="status">
                        <tr>
                            <td>${shop.id }</td>
                            <td>${shop.uid }</td>
                            <td>${shop.itemId }</td>
                            ...
                            <td>${shop.grains }</td>
                            <td>${shop.buyCount }</td>
                             <td>${shop.logReason }</td>
                              <td>${shop.name }</td>
                            <td>${shop.level }</td>
                             <td>${shop.logTime }</td>
                            <td>${shop.registTime }</td>
                        </tr>                        
                    </c:forEach>
