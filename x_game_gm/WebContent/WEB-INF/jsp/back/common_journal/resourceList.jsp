...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/resourseJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">资源日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	...
                    	物品ID：
                    	<input name="itemID" id="inp" style="width: 120px;" value="${param.itemID}" class="search_txt"  />
                    	原因 ：
                	...
                	<a href="<%= request.getContextPath()%>/journal/resourseExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&itemID=${itemID}&res=${res}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="resource" varStatus="status">
                        <tr>
                            <td>${resource.uid }</td>
                            ...
                            <td>${resource.num }</td>
                            <td>${resource.changeNum }</td>
                            <td>${resource.lastNum }</td>
                            <td>${resource.logReason }</td>
                            <td>${resource.logTime }</td>
