...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/moneyPayJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                ...
                <div class="funsearch">
                    <div class="search_list">
                    	...
                    	用户ID：
                    	<input name="userID" id="long" style="width: 120px;" value="${param.userID}" class="search_txt"  />
                    	 商品ID：
                	...
                	<a href="<%= request.getContextPath()%>/journal/moneyPayExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&res=${res}&gid=${gid}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="moneyPay" varStatus="status">
                        <tr>
                            <td>${moneyPay.uid }</td>
                            <td>${moneyPay.name }</td>
                            <td>${moneyPay.level }</td>
                            <td>${moneyPay.channel }</td>
                            <td>${moneyPay.tempId }</td>
                            <td>${moneyPay.productId }</td>
                            <td>${moneyPay.packageName }</td>
                            <td>${moneyPay.orderId }</td>
                            <td>${moneyPay.dollar }</td>
                            <td>${moneyPay.platform }</td>
                            <td>${moneyPay.logReason }</td>
                            <td>${moneyPay.logTime }</td>
                            <td>${moneyPay.registTime }</td>
                        </tr>                        
                    </c:forEach>
