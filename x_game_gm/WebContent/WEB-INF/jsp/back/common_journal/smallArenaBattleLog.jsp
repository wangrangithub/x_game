...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/smallArenaBattleLog">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">小服竞技场战斗日志</span></p>
                </div>
                <!--功能按钮区域-->
                <div class="clear"></div>
                <!--查询条件区域-->
                <div class="funsearch">
                	...
                	<a href="<%= request.getContextPath()%>/journal/smallArenaBattleLogExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&uid=${uid}&arenaId=${arenaId}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">敌方uid</th>
							<th style="width:100px;">竞技场id</th>
							<th style="width:100px;">获取道具</th>
							<th style="width:100px;">排名变化</th>
							<th style="width:100px;">战斗结果(0:输,1:赢)</th>
					...
					<tbody>
						<c:forEach items="${pageModel.dateList}" var="onelog"
							...
							<tr>
								...
								<td style="width:100px;">${onelog.enemyUid}</td>
								<td style="width:100px;">${onelog.arenaId}</td>
								<td style="width:100px;">${onelog.itemList}</td>
								<td style="width:100px;">${onelog.rankChange}</td>
