...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/smallArenaMaxRankLog">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">小服竞技场排行日志</span></p>
                </div>
                <!--功能按钮区域-->
                <div class="clear"></div>
                <!--查询条件区域-->
                <div class="funsearch">
                	...
                	<a href="<%= request.getContextPath()%>/journal/smallArenaMaxRankLogExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&uid=${uid}&arenaId=${arenaId}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:150px;">奖励类型(1:最高段位 2:日结算)</th>
					...
					<tbody>
						<c:forEach items="${pageModel.dateList}" var="onelog"
							...
							<tr>
								...
								<td style="width:100px;">${onelog.rewardType}</td>
