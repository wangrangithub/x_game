...
<body class="">
 <form id="form1" method="post" action="<%=request.getContextPath()%>/journal/mysteryShopBuyJournal">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">日志管理</span><span class="pl5">></span><span class="pl5">神秘商城购买日志</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
                ...
                <div class="funsearch">
                	...
                	<a href="<%= request.getContextPath()%>/journal/mysteryShopBuyExport.do?createdatetimeStart=${createdatetimeStart}&createdatetimeEnd=${createdatetimeEnd}&id=${id}&serverId=${serverId}" class="btn_new commbtn">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">购买商品信息</th>
							<th style="width:100px;">消耗物品</th>
							<th style="width:100px;">购买位置</th>
                    ...
                    <!--数据部分-->
                    <tbody>
                    <c:forEach items="${pageModel.dateList}" var="shopBuy" varStatus="status">
                        <tr>
                            <td>${shopBuy.uid }</td>
                            <td>${shopBuy.name }</td>
                            <td>${shopBuy.buyInfo }</td>
                            <td>${shopBuy.costInfo }</td>
                            <td>${shopBuy.position }</td>

                            <td>${shopBuy.registTime }</td>
                        </tr>                        
                    </c:forEach>
