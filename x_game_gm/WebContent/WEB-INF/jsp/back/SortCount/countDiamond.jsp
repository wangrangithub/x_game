...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/countDiamond">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">关键统计</span><span class="pl5">></span><span class="pl5">钻石产销统计</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">钻石产出(不含充值)</th>
                            <th style="width:100px;">充值产出</th>
							<th style="width:100px;">钻石消耗</th>
