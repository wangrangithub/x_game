...
<body>
	<form id="form1" method="post"
		action="<%=request.getContextPath()%>/SortCount/overview">
		<div class="container">
			<div class="content">
				<div class="loaction">
					<p>
						<span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span
							class="pl5">日常统计</span><span class="pl5">></span><span
							class="pl5">全平台统计</span>
					</p>
				</div>
				<!--功能按钮区域-->
				<!-- <div class="function">
				...
				<div class="funsearch">
					<div class="search_list">
						...
						开始时间： <input name="createdatetimeStart" style="width: 120px;"
							onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
							value="${param.createdatetimeStart }" class="search_txt" />-
						结束时间： <input name="createdatetimeEnd" style="width: 120px;"
							onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
							value="${param.createdatetimeEnd}" class="search_txt" />
				...
				<table id="tabledept" width="100%" border="0" cellspacing="1"
					...
					<thead>
						<tr>
							...
							<th style="width: 100px;">次留</th>
							<th style="width: 100px;">三日留存</th>
							<th style="width: 100px;">七日留存</th>
							<th style="width: 100px;">双周留存</th>
							<th style="width: 100px;">月留存</th>
							<th style="width: 100px;">DAU(活跃用户)</th>
							<th style="width: 100px;">PU(付费用户)</th>
							<th style="width: 100px;">付费率</th>
							<th style="width: 100px;">付费额</th>
							<th style="width: 100px;">ARPPU值</th>
							<th style="width: 100px;">新增付费数</th>
						</tr>
					</thead>
					<!--数据部分-->
					<tbody>
						<c:forEach items="${pageModel.dateList}" var="r"
							varStatus="status">
							<tr>
								<td>${r.day }</td>
								<td>${r.newUserNum }</td>
