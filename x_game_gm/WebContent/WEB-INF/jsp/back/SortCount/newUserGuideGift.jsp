...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/newUserGuideGift">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">分类统计</span><span class="pl5">></span><span class="pl5">新手礼包统计</span></p>
                </div>
                <div class="clear"></div>
                <!--查询条件区域-->
                <div class="funsearch">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">点击次数</th>
							<th style="width:100px;">点击人数</th>
							<th style="width:100px;">每个礼包购买人数</th>
							<th style="width:100px;">所有礼包都购买人数</th>
