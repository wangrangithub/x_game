...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/retentionServer">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">分类统计</span><span class="pl5">></span><span class="pl5">服用户留存</span></p>
                </div>
                <!--功能按钮区域-->
                <div class="clear"></div>
                <!--查询条件区域-->
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">新增</th>
							<th style="width:100px;">D1</th>
							<th style="width:100px;">D2</th>
							<th style="width:100px;">D3</th>
							<th style="width:100px;">D4</th>
							<th style="width:100px;">D5</th>
							
							<th style="width:100px;">D6</th>
							<th style="width:100px;">D7</th>
							<th style="width:100px;">D8</th>
							<th style="width:100px;">D9</th>
							<th style="width:100px;">D10</th>
							<th style="width:100px;">D11</th>
							<th style="width:100px;">D12</th>
							<th style="width:100px;">D13</th>
							<th style="width:100px;">D14</th>
							
							<th style="width:100px;">D15</th>
							<th style="width:100px;">D16</th>
							<th style="width:100px;">D17</th>
							<th style="width:100px;">D18</th>
							<th style="width:100px;">D19</th>
							<th style="width:100px;">D20</th>
							<th style="width:100px;">D21</th>
							<th style="width:100px;">D22</th>
							<th style="width:100px;">D23</th>
							
							<th style="width:100px;">D24</th>
							<th style="width:100px;">D25</th>
							<th style="width:100px;">D26</th>
							<th style="width:100px;">D27</th>
							<th style="width:100px;">D28</th>
							<th style="width:100px;">D29</th>
                        </tr>
                    </thead>
                    <!--数据部分-->
                    <tbody>
