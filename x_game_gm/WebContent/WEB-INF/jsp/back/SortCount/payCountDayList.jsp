...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/payCountDay">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前1位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">分类统计</span><span class="pl5">></span><span class="pl5">付费统计</span></p>
                </div>
                <div class="clear"></div>
                <!--查询条件区域-->
                <div class="funsearch">
