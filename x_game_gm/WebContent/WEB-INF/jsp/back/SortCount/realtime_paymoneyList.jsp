...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/realtime_paymoney">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">实时统计</span><span class="pl5">></span><span class="pl5">实时付费额度</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">日期时间</th>
                            <th style="width:100px;">付费人数</th>
                    ...
                    <c:forEach items="${pageModel.dateList}" var="r" varStatus="status">
                        <tr>
                            ...
                            <td>${r.channel }</td>
                      		...
                      		<th>日期：${dateStart }</td>
                            <th>付费总人数：${ totalPerson}</td>
                            <th>总金额：${totalMoney}</td>
                            <td></td>	
                    </tbody>
                </table>
