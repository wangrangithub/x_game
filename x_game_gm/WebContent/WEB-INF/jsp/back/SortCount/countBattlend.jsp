...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/countBattlend">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">关键统计</span><span class="pl5">></span><span class="pl5">每日战斗统计</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
							...
							<th style="width:100px;">地图战斗次数</th>
							<th style="width:100px;">模组地下城战斗次数</th>
							<th style="width:100px;">觉醒地下城战斗次数</th>
							<th style="width:100px;">竞技场战斗次数</th>
