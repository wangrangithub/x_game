...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/countMaterial">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">关键统计</span><span class="pl5">></span><span class="pl5">材料产销统计</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
               ...
               <table id="tabledept" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:100px;">材料产出(不含购买)</th>
                            <th style="width:100px;">购买产出</th>
							<th style="width:100px;">材料消耗</th>
