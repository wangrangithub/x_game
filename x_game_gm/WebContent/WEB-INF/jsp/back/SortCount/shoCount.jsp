...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/shoCount">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">关键统计</span><span class="pl5">></span><span class="pl5">每日商品销售统计</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
