...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/SortCount/retention_level">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">分类统计</span><span class="pl5">></span><span class="pl5">滞留等级分布</span></p>
                </div>
                <!--功能按钮区域-->
                <!-- <div class="function">
