...
<title>Insert title here</title>
	...
	<script type="text/javascript">
    	function Copys(){
    		$("#formadd").ajaxSubmit({
    			url:"<%= request.getContextPath()%>/shop/copyOffList",
    			type:"post",
    			resetForm:false,
            ...
            <div class="dialog-table"><table width="100%" border="0" cellspacing="0" cellpadding="0"
                   ...
                   <tr>
                    ...
                    <!-- 	<tr>
	                        ...
	                        <td class="white-tr">
	                        	<select class="" id="language[{0}].language" name="contentInfo[0].language">
								 ...
								 <td class="white-tr">
	                            <input type="text" class="form-text" id="txtdeptname" name="contentInfo[0].content" value=""/>
	                            </td>
