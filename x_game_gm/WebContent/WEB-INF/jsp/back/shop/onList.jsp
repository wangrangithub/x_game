...
<body>
 <form id="form1" method="post" action="<%=request.getContextPath()%>/shop/onList">
        <div class="container">
            <div class="content">
                <div class="loaction">
                    <p><span class="pl30">当前位置：</span>后台管理平台<span class="pl5">></span><span class="pl5">活动管理</span><span class="pl5">></span><span class="pl5">上架商品列表</span></p>
                </div>
                <!--功能按钮区域-->
                <div class="function">
