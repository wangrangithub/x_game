            ...
            <div class="dialog-table">
                <table id="ta" width="100%" border="0" cellspacing="0" cellpadding="0" class="tk_table">
                    ...
                    <tr>
                        ...
                        <td class="white-tr">
                        <input type="text" class="" id="txtdeptname" value="${shop.act_name }" onclick="" name="act_name" />
                  		</td>
                    </tr>
                    
                    <tr>
                   		 <td width="100px">活动开始时间：</td>
                    	 <td class="white-tr"><input  name="beginTimes" style="width: 120px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${shop.startTime }" class="search_txt"  />-</td>
                    	
                   	</tr>
                   	 <tr>
                   		<td width="100px">活动结束时间：</td>	
                    	 <td class="white-tr"><input name="endTimes" style="width: 120px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${shop.endTime}" class="search_txt"  /></td>
                   ...
                   <script type="text/javascript">
					...
					<br/><br/><input type="button" onclick="push();" class="search_bt commbtn" value="下架" >
