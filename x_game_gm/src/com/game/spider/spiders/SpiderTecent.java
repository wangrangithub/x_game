...
public class SpiderTecent extends AbstractSpider{
	...
	public void takeContent(Page page) {
		...
		//content = clearStr(content, "</tr>", "");
		//content = clearStr(content, "<td(.*?)>", "");
		//content = clearStr(content, "</td>", "</br>");
		content = CRLF2Blank(content);
		//写HTML文本
	...
	public static void main(String[] args) {
		SpiderTecent spider = new SpiderTecent();
		spider.execute();
	}
}
